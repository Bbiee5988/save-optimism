;; project-funding.clar
;; Save Optimism: A decentralized project funding platform
;; This contract manages the full lifecycle of innovative projects including registration,
