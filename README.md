# Save Optimism: Community-Driven Project Funding

A decentralized project funding platform built on the Stacks blockchain that empowers innovative initiatives through transparent, milestone-based funding mechanisms.

## Overview

Save Optimism introduces a revolutionary phased funding release system where project creators receive portions of their funding only after demonstrating tangible progress on predefined milestones. This approach differs from traditional funding models by:
...
(contract-call? .project-funding create-project 
    "Optimistic Web3 Initiative" 
    "Decentralized innovation platform" 
    u1000000 ;; 1M uSTX funding goal
    u0 ;; Voting-based verification
    u1000) ;; Funding deadline block height

;; Add a milestone
(contract-call? .project-funding add-milestone 
    u1 ;; Project ID
    "Initial Development" 
    "Prototype and core infrastructure" 
    u30 ;; 30% of total funding
    u2000) ;; Deadline block height

;; Back a project
(contract-call? .project-funding back-project 
    u1 ;; Project ID
